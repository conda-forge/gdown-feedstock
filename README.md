...
Feedstock license: [BSD-3-Clause](https://github.com/conda-forge/gdown-feedstock/blob/master/LICENSE.txt)
...
<table><tr><td>All platforms:</td>
    <td>
      <a href="https://dev.azure.com/conda-forge/feedstock-builds/_build/latest?definitionId=7669&branchName=master">
        <img src="https://dev.azure.com/conda-forge/feedstock-builds/_apis/build/status/gdown-feedstock?branchName=master">
      </a>
    </td>
  </tr>
</table>
...
Once the `conda-forge` channel has been enabled, `gdown` can be installed with:

```
conda install gdown
```

It is possible to list all of the versions of `gdown` available on your platform with:
